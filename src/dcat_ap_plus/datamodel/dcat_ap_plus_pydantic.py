...
class Activity(ClassifierMixin):
    ...
    has_categorical_attribute: Optional[list[CategoricalAttribute]] = Field(
        default=None,
        description="""The slot to relate a categorical attribute to an EvaluatedEntity, EvaluatedActivity or AgenticEntity""",
        json_schema_extra={
            "linkml_meta": {
                "alias": "has_categorical_attribute",
...
class CategoricalAttribute(ClassifierMixin):
    """
    A piece of categorical information that is attributed to an Entity, Activity or AgenticEntity. The value is a term from a controlled vocabulary.
    """
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            ...
            "slot_usage": {
                "value": {
                    "description": "The slot to provide the value of the "
                    "CategoricalAttribute as a term from "
    ...
    value: DefinedTerm = Field(
        default=...,
        description="""The slot to provide the value of the CategoricalAttribute as a term from a controlled vocabulary.""",
        json_schema_extra={
            "linkml_meta": {
                "alias": "value",
                "domain_of": [
...
CategoricalAttribute.model_rebuild()
