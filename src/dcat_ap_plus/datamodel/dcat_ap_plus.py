...
# Generation date: 2026-06-11T18:35:17
# Schema: dcat-ap-plus
#
...
class Activity(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self._normalize_inlined_as_list(
            slot_name="has_qualitative_attribute",
            slot_type=QualitativeAttribute,
            key_name="value",
            keyed=False,
        )

        self._normalize_inlined_as_list(
            slot_name="has_quantitative_attribute",
            slot_type=QuantitativeAttribute,
            key_name="value",
            keyed=False,
        )
...
class Catalogue(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self._normalize_inlined_as_list(
            slot_name="record",
            slot_type=CatalogueRecord,
            key_name="modification_date",
            keyed=False,
        )
        ...
        self._normalize_inlined_as_list(
            slot_name="service", slot_type=DataService, key_name="title", keyed=False
        )
        ...
        self._normalize_inlined_as_list(
            slot_name="themes", slot_type=ConceptScheme, key_name="title", keyed=False
        )
...
class Dataset(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self._normalize_inlined_as_list(
            slot_name="creator", slot_type=Agent, key_name="name", keyed=False
        )
        ...
        self._normalize_inlined_as_list(
            slot_name="type", slot_type=Concept, key_name="preferred_label", keyed=False
        )
...
class Distribution(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self._normalize_inlined_as_list(
            slot_name="access_service",
            slot_type=DataService,
            key_name="title",
            keyed=False,
        )
...
slots.access_URL = Slot(
    ...
    model_uri=DCATAP_PLUS.access_URL,
    domain=None,
    range=Optional[str],
)
...
slots.access_rights = Slot(
    ...
    model_uri=DCATAP_PLUS.access_rights,
    domain=None,
    range=Optional[str],
)
...
slots.access_service = Slot(
    ...
    model_uri=DCATAP_PLUS.access_service,
    domain=None,
    range=Optional[str],
)
...
slots.algorithm = Slot(
    ...
    model_uri=DCATAP_PLUS.algorithm,
    domain=None,
    range=Optional[str],
)
...
slots.applicable_legislation = Slot(
    ...
    model_uri=DCATAP_PLUS.applicable_legislation,
    domain=None,
    range=Optional[str],
)
...
slots.application_profile = Slot(
    ...
    model_uri=DCATAP_PLUS.application_profile,
    domain=None,
    range=Optional[str],
)
...
slots.availability = Slot(
    ...
    model_uri=DCATAP_PLUS.availability,
    domain=None,
    range=Optional[str],
)
...
slots.beginning = Slot(
    ...
    model_uri=DCATAP_PLUS.beginning,
    domain=None,
    range=Optional[str],
)
...
slots.byte_size = Slot(
    ...
    model_uri=DCATAP_PLUS.byte_size,
    domain=None,
    range=Optional[str],
)
...
slots.carried_out_by = Slot(
    ...
    model_uri=DCATAP_PLUS.carried_out_by,
    domain=None,
    range=Optional[
        Union[
            dict[Union[str, AgenticEntityId], Union[dict, AgenticEntity]],
...
slots.catalogue = Slot(
    ...
    model_uri=DCATAP_PLUS.catalogue,
    domain=None,
    range=Optional[str],
)
...
slots.centroid = Slot(
    ...
    model_uri=DCATAP_PLUS.centroid,
    domain=None,
    range=Optional[str],
)
...
slots.change_type = Slot(
    ...
    model_uri=DCATAP_PLUS.change_type,
    domain=None,
    range=Optional[str],
)
...
slots.checksum = Slot(
    ...
    model_uri=DCATAP_PLUS.checksum,
    domain=None,
    range=Optional[str],
)
...
slots.checksum_value = Slot(
    ...
    model_uri=DCATAP_PLUS.checksum_value,
    domain=None,
    range=Optional[str],
)
...
slots.compression_format = Slot(
    ...
    model_uri=DCATAP_PLUS.compression_format,
    domain=None,
    range=Optional[str],
)
...
slots.conforms_to = Slot(
    ...
    name="conforms_to",
    curie=DCTERMS.curie("conformsTo"),
    model_uri=DCATAP_PLUS.conforms_to,
    domain=None,
    range=Optional[str],
)
...
slots.contact_point = Slot(
    ...
    model_uri=DCATAP_PLUS.contact_point,
    domain=None,
    range=Optional[str],
)
...
slots.dataset_distribution = Slot(
    ...
    model_uri=DCATAP_PLUS.dataset_distribution,
    domain=None,
    range=Optional[str],
)
...
slots.description = Slot(
    ...
    model_uri=DCATAP_PLUS.description,
    domain=None,
    range=Optional[str],
)
...
slots.documentation = Slot(
    ...
    model_uri=DCATAP_PLUS.documentation,
    domain=None,
    range=Optional[str],
)
...
slots.download_URL = Slot(
    ...
    model_uri=DCATAP_PLUS.download_URL,
    domain=None,
    range=Optional[str],
)
...
slots.end_date = Slot(
    ...
    model_uri=DCATAP_PLUS.end_date,
    domain=None,
    range=Optional[str],
)
...
slots.endpoint_URL = Slot(
    ...
    model_uri=DCATAP_PLUS.endpoint_URL,
    domain=None,
    range=Optional[str],
)
...
slots.endpoint_description = Slot(
    ...
    model_uri=DCATAP_PLUS.endpoint_description,
    domain=None,
    range=Optional[str],
)
...
slots.evaluated_activity = Slot(
    ...
    model_uri=DCATAP_PLUS.evaluated_activity,
    domain=None,
    range=Optional[
        Union[
            dict[Union[str, EvaluatedActivityId], Union[dict, EvaluatedActivity]],
...
slots.evaluated_entity = Slot(
    ...
    model_uri=DCATAP_PLUS.evaluated_entity,
    domain=None,
    range=Optional[
        Union[
            dict[Union[str, EvaluatedEntityId], Union[dict, EvaluatedEntity]],
...
slots.frequency = Slot(
    ...
    model_uri=DCATAP_PLUS.frequency,
    domain=None,
    range=Optional[str],
)
...
slots.geographical_coverage = Slot(
    ...
    model_uri=DCATAP_PLUS.geographical_coverage,
    domain=None,
    range=Optional[str],
)
...
slots.geometry = Slot(
    ...
    model_uri=DCATAP_PLUS.geometry,
    domain=None,
    range=Optional[str],
)
...
slots.had_input_activity = Slot(
    ...
    curie=PROV.curie("wasInformedBy"),
    model_uri=DCATAP_PLUS.had_input_activity,
    domain=None,
    range=Optional[
        Union[
            dict[Union[str, ActivityId], Union[dict, Activity]],
...
slots.had_input_entity = Slot(
    ...
    curie=PROV.curie("used"),
    model_uri=DCATAP_PLUS.had_input_entity,
    domain=None,
    range=Optional[
        Union[
...
slots.had_output_entity = Slot(
    ...
    model_uri=DCATAP_PLUS.had_output_entity,
    domain=None,
    range=Optional[
        Union[
            dict[Union[str, EntityId], Union[dict, Entity]], list[Union[dict, Entity]]
...
slots.had_role = Slot(
    ...
    model_uri=DCATAP_PLUS.had_role,
    domain=None,
    range=Optional[str],
)
...
slots.has_dataset = Slot(
    ...
    model_uri=DCATAP_PLUS.has_dataset,
    domain=None,
    range=Optional[str],
)
...
slots.has_part = Slot(
    ...
    model_uri=DCATAP_PLUS.has_part,
    domain=None,
...
slots.has_policy = Slot(
    ...
    model_uri=DCATAP_PLUS.has_policy,
    domain=None,
    range=Optional[str],
)
...
slots.has_qualitative_attribute = Slot(
    ...
    model_uri=DCATAP_PLUS.has_qualitative_attribute,
    domain=None,
    range=Optional[
        Union[
...
slots.has_quantitative_attribute = Slot(
    ...
    curie=DCTERMS.curie("relation"),
    model_uri=DCATAP_PLUS.has_quantitative_attribute,
    domain=None,
    range=Optional[
        Union[
...
slots.has_version = Slot(
    ...
    model_uri=DCATAP_PLUS.has_version,
    domain=None,
    range=Optional[str],
)
...
slots.homepage = Slot(
    ...
    model_uri=DCATAP_PLUS.homepage,
    domain=None,
    range=Optional[str],
)
...
slots.id = Slot(
    uri=DCATAP_PLUS.id,
    name="id",
    curie=DCATAP_PLUS.curie("id"),
    model_uri=DCATAP_PLUS.id,
    domain=None,
    range=URIRef,
)
...
slots.identifier = Slot(
    ...
    model_uri=DCATAP_PLUS.identifier,
    domain=None,
    range=Optional[str],
)
...
slots.in_series = Slot(
    ...
    model_uri=DCATAP_PLUS.in_series,
    domain=None,
    range=Optional[str],
)
...
slots.is_about_activity = Slot(
    ...
    model_uri=DCATAP_PLUS.is_about_activity,
    domain=None,
    range=Optional[
        Union[
            dict[Union[str, EvaluatedActivityId], Union[dict, EvaluatedActivity]],
...
slots.is_about_entity = Slot(
    ...
    curie=DCTERMS.curie("subject"),
    model_uri=DCATAP_PLUS.is_about_entity,
    domain=None,
    range=Optional[
        Union[
            dict[Union[str, EvaluatedEntityId], Union[dict, EvaluatedEntity]],
...
slots.is_referenced_by = Slot(
    ...
    model_uri=DCATAP_PLUS.is_referenced_by,
    domain=None,
    range=Optional[str],
)
...
slots.landing_page = Slot(
    ...
    model_uri=DCATAP_PLUS.landing_page,
    domain=None,
    range=Optional[str],
)
...
slots.language = Slot(
    ...
    model_uri=DCATAP_PLUS.language,
    domain=None,
    range=Optional[str],
)
...
slots.linked_schemas = Slot(
    ...
    name="linked_schemas",
    curie=DCTERMS.curie("conformsTo"),
    model_uri=DCATAP_PLUS.linked_schemas,
    domain=None,
    range=Optional[str],
)
...
slots.listing_date = Slot(
    ...
    model_uri=DCATAP_PLUS.listing_date,
    domain=None,
    range=Optional[str],
)
...
slots.media_type = Slot(
    ...
    model_uri=DCATAP_PLUS.media_type,
    domain=None,
    range=Optional[str],
)
...
slots.modification_date = Slot(
    ...
    model_uri=DCATAP_PLUS.modification_date,
    domain=None,
    range=Optional[str],
)
...
slots.notation = Slot(
    ...
    model_uri=DCATAP_PLUS.notation,
    domain=None,
    range=Optional[str],
)
...
slots.occurred_in = Slot(
    ...
    model_uri=DCATAP_PLUS.occurred_in,
    domain=None,
...
slots.other_identifier = Slot(
    ...
    model_uri=DCATAP_PLUS.other_identifier,
    domain=None,
    range=Optional[str],
)
...
slots.packaging_format = Slot(
    ...
    model_uri=DCATAP_PLUS.packaging_format,
    domain=None,
    range=Optional[str],
)
...
slots.preferred_label = Slot(
    ...
    model_uri=DCATAP_PLUS.preferred_label,
    domain=None,
    range=Optional[str],
)
...
slots.primary_topic = Slot(
    ...
    model_uri=DCATAP_PLUS.primary_topic,
    domain=None,
    range=Optional[str],
)
...
slots.provenance = Slot(
    ...
    model_uri=DCATAP_PLUS.provenance,
    domain=None,
    range=Optional[str],
)
...
slots.publisher = Slot(
    ...
    model_uri=DCATAP_PLUS.publisher,
    domain=None,
    range=Optional[str],
)
...
slots.qualified_attribution = Slot(
    ...
    model_uri=DCATAP_PLUS.qualified_attribution,
    domain=None,
    range=Optional[str],
)
...
slots.qualified_relation = Slot(
    ...
    model_uri=DCATAP_PLUS.qualified_relation,
    domain=None,
    range=Optional[str],
)
...
slots.rdf_type = Slot(
    ...
    model_uri=DCATAP_PLUS.rdf_type,
    domain=None,
...
slots.realized_plan = Slot(
    ...
    name="realized_plan",
    curie=PROV.curie("used"),
    model_uri=DCATAP_PLUS.realized_plan,
    domain=None,
...
slots.related_resource = Slot(
    ...
    curie=DCTERMS.curie("relation"),
    model_uri=DCATAP_PLUS.related_resource,
    domain=None,
    range=Optional[str],
)
...
slots.relation = Slot(
    ...
    name="relation",
    curie=DCTERMS.curie("relation"),
    model_uri=DCATAP_PLUS.relation,
    domain=None,
    range=Optional[str],
)
...
slots.release_date = Slot(
    ...
    name="release_date",
    curie=DCTERMS.curie("issued"),
    model_uri=DCATAP_PLUS.release_date,
    domain=None,
    range=Optional[str],
)
...
slots.serves_dataset = Slot(
    ...
    model_uri=DCATAP_PLUS.serves_dataset,
    domain=None,
    range=Optional[str],
)
...
slots.source_metadata = Slot(
    ...
    curie=DCTERMS.curie("source"),
    model_uri=DCATAP_PLUS.source_metadata,
    domain=None,
    range=Optional[str],
)
...
slots.spatial_resolution = Slot(
    ...
    model_uri=DCATAP_PLUS.spatial_resolution,
    domain=None,
    range=Optional[str],
)
...
slots.start_date = Slot(
    ...
    model_uri=DCATAP_PLUS.start_date,
    domain=None,
    range=Optional[str],
)
...
slots.temporal_coverage = Slot(
    ...
    model_uri=DCATAP_PLUS.temporal_coverage,
    domain=None,
    range=Optional[str],
)
...
slots.temporal_resolution = Slot(
    ...
    model_uri=DCATAP_PLUS.temporal_resolution,
    domain=None,
    range=Optional[str],
)
...
slots.version_notes = Slot(
    ...
    model_uri=DCATAP_PLUS.version_notes,
    domain=None,
    range=Optional[str],
)
...
slots.was_generated_by = Slot(
    ...
    model_uri=DCATAP_PLUS.was_generated_by,
    domain=None,
    range=Optional[str],
)
...
slots.definedTerm__from_CV = Slot(
    ...
    model_uri=DCATAP_PLUS.definedTerm__from_CV,
    domain=None,
...
slots.quantitativeAttribute__has_quantity_type = Slot(
    ...
    model_uri=DCATAP_PLUS.quantitativeAttribute__has_quantity_type,
    domain=None,
...
slots.quantitativeAttribute__unit = Slot(
    ...
    model_uri=DCATAP_PLUS.quantitativeAttribute__unit,
    domain=None,
...
slots.Activity_title = Slot(
    ...
    name="Activity_title",
    curie=DCTERMS.curie("title"),
    model_uri=DCATAP_PLUS.Activity_title,
    domain=Activity,
...
slots.Activity_description = Slot(
    ...
    curie=DCTERMS.curie("description"),
    model_uri=DCATAP_PLUS.Activity_description,
    domain=Activity,
    range=Optional[Union[str, list[str]]],
)
...
slots.Activity_has_part = Slot(
    ...
    curie=DCTERMS.curie("hasPart"),
    model_uri=DCATAP_PLUS.Activity_has_part,
    domain=Activity,
    range=Optional[
        Union[
            dict[Union[str, ActivityId], Union[dict, "Activity"]],
...
slots.Activity_part_of = Slot(
    ...
    curie=DCTERMS.curie("isPartOf"),
    model_uri=DCATAP_PLUS.Activity_part_of,
    domain=Activity,
    range=Optional[
        Union[
            dict[Union[str, ActivityId], Union[dict, "Activity"]],
...
slots.Activity_other_identifier = Slot(
    ...
    curie=ADMS.curie("identifier"),
    model_uri=DCATAP_PLUS.Activity_other_identifier,
    domain=Activity,
...
slots.Activity_has_qualitative_attribute = Slot(
    ...
    curie=DCTERMS.curie("relation"),
    model_uri=DCATAP_PLUS.Activity_has_qualitative_attribute,
    domain=Activity,
    range=Optional[
        Union[
            Union[dict, "QualitativeAttribute"],
...
slots.Activity_has_quantitative_attribute = Slot(
    ...
    curie=DCTERMS.curie("relation"),
    model_uri=DCATAP_PLUS.Activity_has_quantitative_attribute,
    domain=Activity,
    range=Optional[
        Union[
            Union[dict, "QuantitativeAttribute"],
...
slots.Activity_had_input_entity = Slot(
    ...
    curie=PROV.curie("used"),
    model_uri=DCATAP_PLUS.Activity_had_input_entity,
    domain=Activity,
    range=Optional[
        Union[
            dict[Union[str, EntityId], Union[dict, "Entity"]],
...
slots.Activity_had_output_entity = Slot(
    ...
    curie=PROV.curie("generated"),
    model_uri=DCATAP_PLUS.Activity_had_output_entity,
    domain=Activity,
    range=Optional[
        Union[
            dict[Union[str, EntityId], Union[dict, "Entity"]],
...
slots.Activity_had_input_activity = Slot(
    ...
    curie=PROV.curie("wasInformedBy"),
    model_uri=DCATAP_PLUS.Activity_had_input_activity,
    domain=Activity,
    range=Optional[
        Union[
            dict[Union[str, ActivityId], Union[dict, "Activity"]],
...
slots.Activity_carried_out_by = Slot(
    ...
    curie=PROV.curie("wasAssociatedWith"),
    model_uri=DCATAP_PLUS.Activity_carried_out_by,
    domain=Activity,
    range=Optional[
        Union[
            dict[Union[str, AgenticEntityId], Union[dict, "AgenticEntity"]],
...
slots.Agent_name = Slot(
    ...
    name="Agent_name",
    curie=FOAF.curie("name"),
    model_uri=DCATAP_PLUS.Agent_name,
    domain=Agent,
...
slots.Agent_type = Slot(
    ...
    name="Agent_type",
    curie=DCTERMS.curie("type"),
    model_uri=DCATAP_PLUS.Agent_type,
    domain=Agent,
...
slots.AgenticEntity_has_part = Slot(
    ...
    curie=DCTERMS.curie("hasPart"),
    model_uri=DCATAP_PLUS.AgenticEntity_has_part,
...
slots.AgenticEntity_part_of = Slot(
    ...
    curie=DCTERMS.curie("isPartOf"),
    model_uri=DCATAP_PLUS.AgenticEntity_part_of,
    domain=AgenticEntity,
    range=Optional[
        Union[
            dict[Union[str, AgenticEntityId], Union[dict, "AgenticEntity"]],
...
slots.AgenticEntity_other_identifier = Slot(
    ...
    curie=ADMS.curie("identifier"),
    model_uri=DCATAP_PLUS.AgenticEntity_other_identifier,
    domain=AgenticEntity,
    range=Optional[Union[Union[dict, "Identifier"], list[Union[dict, "Identifier"]]]],
)
...
slots.AnalysisDataset_was_generated_by = Slot(
    ...
    curie=PROV.curie("wasGeneratedBy"),
    model_uri=DCATAP_PLUS.AnalysisDataset_was_generated_by,
...
slots.AnalysisSourceData_was_generated_by = Slot(
    ...
    curie=PROV.curie("wasGeneratedBy"),
    model_uri=DCATAP_PLUS.AnalysisSourceData_was_generated_by,
...
slots.Catalogue_applicable_legislation = Slot(
    ...
    curie=DCATAP.curie("applicableLegislation"),
    model_uri=DCATAP_PLUS.Catalogue_applicable_legislation,
    domain=Catalogue,
    range=Optional[
        Union[
            dict[Union[str, LegalResourceId], Union[dict, "LegalResource"]],
...
slots.Catalogue_catalogue = Slot(
    ...
    curie=DCAT.curie("catalog"),
    model_uri=DCATAP_PLUS.Catalogue_catalogue,
    domain=Catalogue,
...
slots.Catalogue_creator = Slot(
    ...
    curie=DCTERMS.curie("creator"),
    model_uri=DCATAP_PLUS.Catalogue_creator,
    domain=Catalogue,
...
slots.Catalogue_description = Slot(
    ...
    curie=DCTERMS.curie("description"),
    model_uri=DCATAP_PLUS.Catalogue_description,
    domain=Catalogue,
    range=Union[str, list[str]],
)
...
slots.Catalogue_geographical_coverage = Slot(
    ...
    curie=DCTERMS.curie("spatial"),
    model_uri=DCATAP_PLUS.Catalogue_geographical_coverage,
    domain=Catalogue,
...
slots.Catalogue_has_dataset = Slot(
    ...
    curie=DCAT.curie("dataset"),
    model_uri=DCATAP_PLUS.Catalogue_has_dataset,
    domain=Catalogue,
    range=Optional[
        Union[
            dict[Union[str, DatasetId], Union[dict, "Dataset"]],
...
slots.Catalogue_has_part = Slot(
    ...
    curie=DCTERMS.curie("hasPart"),
    model_uri=DCATAP_PLUS.Catalogue_has_part,
    domain=Catalogue,
    range=Optional[Union[Union[dict, "Catalogue"], list[Union[dict, "Catalogue"]]]],
)
...
slots.Catalogue_homepage = Slot(
    ...
    curie=FOAF.curie("homepage"),
    model_uri=DCATAP_PLUS.Catalogue_homepage,
    domain=Catalogue,
...
slots.Catalogue_language = Slot(
    ...
    curie=DCTERMS.curie("language"),
    model_uri=DCATAP_PLUS.Catalogue_language,
    domain=Catalogue,
    range=Optional[
        Union[Union[dict, "LinguisticSystem"], list[Union[dict, "LinguisticSystem"]]]
    ],
...
slots.Catalogue_licence = Slot(
    ...
    curie=DCTERMS.curie("license"),
    model_uri=DCATAP_PLUS.Catalogue_licence,
    domain=Catalogue,
...
slots.Catalogue_modification_date = Slot(
    ...
    curie=DCTERMS.curie("modified"),
    model_uri=DCATAP_PLUS.Catalogue_modification_date,
    domain=Catalogue,
...
slots.Catalogue_publisher = Slot(
    ...
    curie=DCTERMS.curie("publisher"),
    model_uri=DCATAP_PLUS.Catalogue_publisher,
    domain=Catalogue,
...
slots.Catalogue_record = Slot(
    ...
    curie=DCAT.curie("record"),
    model_uri=DCATAP_PLUS.Catalogue_record,
    domain=Catalogue,
    range=Optional[
        Union[Union[dict, "CatalogueRecord"], list[Union[dict, "CatalogueRecord"]]]
    ],
...
slots.Catalogue_release_date = Slot(
    ...
    curie=DCTERMS.curie("issued"),
    model_uri=DCATAP_PLUS.Catalogue_release_date,
    domain=Catalogue,
    range=Optional[Union[str, XSDDate]],
)
...
slots.Catalogue_rights = Slot(
    ...
    curie=DCTERMS.curie("rights"),
    model_uri=DCATAP_PLUS.Catalogue_rights,
    domain=Catalogue,
...
slots.Catalogue_service = Slot(
    ...
    curie=DCAT.curie("service"),
    model_uri=DCATAP_PLUS.Catalogue_service,
    domain=Catalogue,
...
slots.Catalogue_temporal_coverage = Slot(
    ...
    curie=DCTERMS.curie("temporal"),
    model_uri=DCATAP_PLUS.Catalogue_temporal_coverage,
    domain=Catalogue,
    range=Optional[
        Union[Union[dict, "PeriodOfTime"], list[Union[dict, "PeriodOfTime"]]]
    ],
...
slots.Catalogue_themes = Slot(
    ...
    curie=DCAT.curie("themeTaxonomy"),
    model_uri=DCATAP_PLUS.Catalogue_themes,
    domain=Catalogue,
    range=Optional[
        Union[Union[dict, "ConceptScheme"], list[Union[dict, "ConceptScheme"]]]
    ],
...
slots.Catalogue_title = Slot(
    ...
    curie=DCTERMS.curie("title"),
    model_uri=DCATAP_PLUS.Catalogue_title,
    domain=Catalogue,
    range=Union[str, list[str]],
)
...
slots.CatalogueRecord_application_profile = Slot(
    ...
    curie=DCTERMS.curie("conformsTo"),
    model_uri=DCATAP_PLUS.CatalogueRecord_application_profile,
...
slots.CatalogueRecord_change_type = Slot(
    ...
    curie=ADMS.curie("status"),
    model_uri=DCATAP_PLUS.CatalogueRecord_change_type,
    domain=CatalogueRecord,
    range=Optional[Union[dict, "Concept"]],
)
...
slots.CatalogueRecord_description = Slot(
    ...
    curie=DCTERMS.curie("description"),
    model_uri=DCATAP_PLUS.CatalogueRecord_description,
    domain=CatalogueRecord,
    range=Optional[Union[str, list[str]]],
)
...
slots.CatalogueRecord_language = Slot(
    ...
    curie=DCTERMS.curie("language"),
    model_uri=DCATAP_PLUS.CatalogueRecord_language,
    domain=CatalogueRecord,
    range=Optional[
        Union[Union[dict, "LinguisticSystem"], list[Union[dict, "LinguisticSystem"]]]
    ],
...
slots.CatalogueRecord_listing_date = Slot(
    ...
    curie=DCTERMS.curie("issued"),
    model_uri=DCATAP_PLUS.CatalogueRecord_listing_date,
    domain=CatalogueRecord,
    range=Optional[Union[str, XSDDate]],
)
...
slots.CatalogueRecord_modification_date = Slot(
    ...
    curie=DCTERMS.curie("modified"),
    model_uri=DCATAP_PLUS.CatalogueRecord_modification_date,
    domain=CatalogueRecord,
...
slots.CatalogueRecord_primary_topic = Slot(
    ...
    curie=FOAF.curie("primaryTopic"),
    model_uri=DCATAP_PLUS.CatalogueRecord_primary_topic,
    domain=CatalogueRecord,
...
slots.CatalogueRecord_source_metadata = Slot(
    ...
    curie=DCTERMS.curie("source"),
    model_uri=DCATAP_PLUS.CatalogueRecord_source_metadata,
    domain=CatalogueRecord,
...
slots.CatalogueRecord_title = Slot(
    ...
    curie=DCTERMS.curie("title"),
    model_uri=DCATAP_PLUS.CatalogueRecord_title,
    domain=CatalogueRecord,
    range=Optional[Union[str, list[str]]],
)
...
slots.Checksum_algorithm = Slot(
    ...
    curie=SPDX.curie("algorithm"),
    model_uri=DCATAP_PLUS.Checksum_algorithm,
    domain=Checksum,
...
slots.Checksum_checksum_value = Slot(
    ...
    curie=SPDX.curie("checksumValue"),
    model_uri=DCATAP_PLUS.Checksum_checksum_value,
    domain=Checksum,
    range=str,
)
...
slots.ClassifierMixin_type = Slot(
    ...
    curie=DCTERMS.curie("type"),
    model_uri=DCATAP_PLUS.ClassifierMixin_type,
    domain=None,
    range=Optional[Union[dict, "DefinedTerm"]],
)
...
slots.Concept_preferred_label = Slot(
    ...
    curie=SKOS.curie("prefLabel"),
    model_uri=DCATAP_PLUS.Concept_preferred_label,
    domain=Concept,
    range=Union[str, list[str]],
)
...
slots.ConceptScheme_title = Slot(
    ...
    curie=DCTERMS.curie("title"),
    model_uri=DCATAP_PLUS.ConceptScheme_title,
...
slots.DataAnalysis_evaluated_entity = Slot(
    ...
    curie=PROV.curie("used"),
    model_uri=DCATAP_PLUS.DataAnalysis_evaluated_entity,
    domain=DataAnalysis,
    range=Optional[
        Union[
            dict[Union[str, AnalysisSourceDataId], Union[dict, "AnalysisSourceData"]],
...
slots.DataService_access_rights = Slot(
    ...
    curie=DCTERMS.curie("accessRights"),
    model_uri=DCATAP_PLUS.DataService_access_rights,
    domain=DataService,
    range=Optional[Union[dict, "RightsStatement"]],
)
...
slots.DataService_applicable_legislation = Slot(
    ...
    curie=DCATAP.curie("applicableLegislation"),
    model_uri=DCATAP_PLUS.DataService_applicable_legislation,
    domain=DataService,
    range=Optional[
        Union[
            dict[Union[str, LegalResourceId], Union[dict, "LegalResource"]],
...
slots.DataService_conforms_to = Slot(
    ...
    curie=DCTERMS.curie("conformsTo"),
    model_uri=DCATAP_PLUS.DataService_conforms_to,
    domain=DataService,
    range=Optional[Union[Union[dict, "Standard"], list[Union[dict, "Standard"]]]],
)
...
slots.DataService_contact_point = Slot(
    ...
    curie=DCAT.curie("contactPoint"),
    model_uri=DCATAP_PLUS.DataService_contact_point,
    domain=DataService,
...
slots.DataService_description = Slot(
    ...
    curie=DCTERMS.curie("description"),
    model_uri=DCATAP_PLUS.DataService_description,
    domain=DataService,
    range=Optional[Union[str, list[str]]],
)
...
slots.DataService_documentation = Slot(
    ...
    curie=FOAF.curie("page"),
    model_uri=DCATAP_PLUS.DataService_documentation,
    domain=DataService,
    range=Optional[
        Union[
            dict[Union[str, DocumentId], Union[dict, "Document"]],
...
slots.DataService_endpoint_URL = Slot(
    ...
    curie=DCAT.curie("endpointURL"),
    model_uri=DCATAP_PLUS.DataService_endpoint_URL,
    domain=DataService,
    range=Union[
        dict[Union[str, ResourceId], Union[dict, "Resource"]],
        list[Union[dict, "Resource"]],
...
slots.DataService_endpoint_description = Slot(
    ...
    curie=DCAT.curie("endpointDescription"),
    model_uri=DCATAP_PLUS.DataService_endpoint_description,
    domain=DataService,
    range=Optional[
        Union[
            dict[Union[str, ResourceId], Union[dict, "Resource"]],
...
slots.DataService_format = Slot(
    ...
    curie=DCTERMS.curie("format"),
    model_uri=DCATAP_PLUS.DataService_format,
    domain=DataService,
    range=Optional[
        Union[Union[dict, "MediaTypeOrExtent"], list[Union[dict, "MediaTypeOrExtent"]]]
    ],
...
slots.DataService_keyword = Slot(
    ...
    curie=DCAT.curie("keyword"),
    model_uri=DCATAP_PLUS.DataService_keyword,
    domain=DataService,
    range=Optional[Union[str, list[str]]],
)
...
slots.DataService_landing_page = Slot(
    ...
    curie=DCAT.curie("landingPage"),
    model_uri=DCATAP_PLUS.DataService_landing_page,
    domain=DataService,
    range=Optional[
        Union[
            dict[Union[str, DocumentId], Union[dict, "Document"]],
...
slots.DataService_licence = Slot(
    ...
    curie=DCTERMS.curie("license"),
    model_uri=DCATAP_PLUS.DataService_licence,
    domain=DataService,
    range=Optional[Union[dict, "LicenseDocument"]],
)
...
slots.DataService_publisher = Slot(
    ...
    curie=DCTERMS.curie("publisher"),
    model_uri=DCATAP_PLUS.DataService_publisher,
    domain=DataService,
    range=Optional[Union[dict, Agent]],
)
...
slots.DataService_serves_dataset = Slot(
    ...
    curie=DCAT.curie("servesDataset"),
    model_uri=DCATAP_PLUS.DataService_serves_dataset,
    domain=DataService,
    range=Optional[
        Union[
            dict[Union[str, DatasetId], Union[dict, "Dataset"]],
...
slots.DataService_theme = Slot(
    ...
    curie=DCAT.curie("theme"),
    model_uri=DCATAP_PLUS.DataService_theme,
    domain=DataService,
...
slots.DataService_title = Slot(
    ...
    curie=DCTERMS.curie("title"),
    model_uri=DCATAP_PLUS.DataService_title,
    domain=DataService,
    range=Union[str, list[str]],
)
...
slots.Dataset_access_rights = Slot(
    ...
    curie=DCTERMS.curie("accessRights"),
    model_uri=DCATAP_PLUS.Dataset_access_rights,
    domain=Dataset,
    range=Optional[Union[dict, "RightsStatement"]],
)
...
slots.Dataset_applicable_legislation = Slot(
    ...
    curie=DCATAP.curie("applicableLegislation"),
    model_uri=DCATAP_PLUS.Dataset_applicable_legislation,
    domain=Dataset,
    range=Optional[
        Union[
            dict[Union[str, LegalResourceId], Union[dict, "LegalResource"]],
...
slots.Dataset_conforms_to = Slot(
    ...
    curie=DCTERMS.curie("conformsTo"),
    model_uri=DCATAP_PLUS.Dataset_conforms_to,
    domain=Dataset,
    range=Optional[Union[Union[dict, "Standard"], list[Union[dict, "Standard"]]]],
)
...
slots.Dataset_contact_point = Slot(
    ...
    curie=DCAT.curie("contactPoint"),
    model_uri=DCATAP_PLUS.Dataset_contact_point,
    domain=Dataset,
    range=Optional[Union[Union[dict, "Kind"], list[Union[dict, "Kind"]]]],
)
...
slots.Dataset_creator = Slot(
    ...
    curie=DCTERMS.curie("creator"),
    model_uri=DCATAP_PLUS.Dataset_creator,
    domain=Dataset,
...
slots.Dataset_dataset_distribution = Slot(
    ...
    curie=DCAT.curie("distribution"),
    model_uri=DCATAP_PLUS.Dataset_dataset_distribution,
    domain=Dataset,
    range=Optional[
        Union[Union[dict, "Distribution"], list[Union[dict, "Distribution"]]]
    ],
...
slots.Dataset_description = Slot(
    ...
    curie=DCTERMS.curie("description"),
    model_uri=DCATAP_PLUS.Dataset_description,
    domain=Dataset,
    range=Union[str, list[str]],
)
...
slots.Dataset_documentation = Slot(
    ...
    curie=FOAF.curie("page"),
    model_uri=DCATAP_PLUS.Dataset_documentation,
    domain=Dataset,
    range=Optional[
        Union[
            dict[Union[str, DocumentId], Union[dict, "Document"]],
...
slots.Dataset_frequency = Slot(
    ...
    curie=DCTERMS.curie("accrualPeriodicity"),
    model_uri=DCATAP_PLUS.Dataset_frequency,
    domain=Dataset,
...
slots.Dataset_geographical_coverage = Slot(
    ...
    curie=DCTERMS.curie("spatial"),
    model_uri=DCATAP_PLUS.Dataset_geographical_coverage,
    domain=Dataset,
    range=Optional[Union[Union[dict, "Location"], list[Union[dict, "Location"]]]],
)
...
slots.Dataset_has_version = Slot(
    ...
    curie=DCAT.curie("hasVersion"),
    model_uri=DCATAP_PLUS.Dataset_has_version,
    domain=Dataset,
    range=Optional[
        Union[
            dict[Union[str, DatasetId], Union[dict, "Dataset"]],
...
slots.Dataset_identifier = Slot(
    ...
    curie=DCTERMS.curie("identifier"),
    model_uri=DCATAP_PLUS.Dataset_identifier,
    domain=Dataset,
    range=Optional[Union[str, list[str]]],
)
...
slots.Dataset_in_series = Slot(
    ...
    curie=DCAT.curie("inSeries"),
    model_uri=DCATAP_PLUS.Dataset_in_series,
    domain=Dataset,
    range=Optional[
        Union[Union[dict, "DatasetSeries"], list[Union[dict, "DatasetSeries"]]]
    ],
...
slots.Dataset_is_referenced_by = Slot(
    ...
    curie=DCTERMS.curie("isReferencedBy"),
    model_uri=DCATAP_PLUS.Dataset_is_referenced_by,
    domain=Dataset,
    range=Optional[
        Union[
            dict[Union[str, ResourceId], Union[dict, "Resource"]],
...
slots.Dataset_keyword = Slot(
    ...
    curie=DCAT.curie("keyword"),
    model_uri=DCATAP_PLUS.Dataset_keyword,
    domain=Dataset,
    range=Optional[Union[str, list[str]]],
)
...
slots.Dataset_landing_page = Slot(
    ...
    curie=DCAT.curie("landingPage"),
    model_uri=DCATAP_PLUS.Dataset_landing_page,
    domain=Dataset,
    range=Optional[
        Union[
            dict[Union[str, DocumentId], Union[dict, "Document"]],
...
slots.Dataset_language = Slot(
    ...
    curie=DCTERMS.curie("language"),
    model_uri=DCATAP_PLUS.Dataset_language,
    domain=Dataset,
    range=Optional[
        Union[Union[dict, "LinguisticSystem"], list[Union[dict, "LinguisticSystem"]]]
    ],
...
slots.Dataset_modification_date = Slot(
    ...
    curie=DCTERMS.curie("modified"),
    model_uri=DCATAP_PLUS.Dataset_modification_date,
    domain=Dataset,
    range=Optional[Union[str, XSDDate]],
)
...
slots.Dataset_other_identifier = Slot(
    ...
    curie=ADMS.curie("identifier"),
    model_uri=DCATAP_PLUS.Dataset_other_identifier,
    domain=Dataset,
    range=Optional[Union[Union[dict, "Identifier"], list[Union[dict, "Identifier"]]]],
)
...
slots.Dataset_provenance = Slot(
    ...
    curie=DCTERMS.curie("provenance"),
    model_uri=DCATAP_PLUS.Dataset_provenance,
    domain=Dataset,
    range=Optional[
        Union[
            Union[dict, "ProvenanceStatement"], list[Union[dict, "ProvenanceStatement"]]
...
slots.Dataset_publisher = Slot(
    ...
    curie=DCTERMS.curie("publisher"),
    model_uri=DCATAP_PLUS.Dataset_publisher,
    domain=Dataset,
    range=Optional[Union[dict, Agent]],
)
...
slots.Dataset_qualified_attribution = Slot(
    ...
    curie=PROV.curie("qualifiedAttribution"),
    model_uri=DCATAP_PLUS.Dataset_qualified_attribution,
    domain=Dataset,
...
slots.Dataset_qualified_relation = Slot(
    ...
    curie=DCAT.curie("qualifiedRelation"),
    model_uri=DCATAP_PLUS.Dataset_qualified_relation,
    domain=Dataset,
    range=Optional[
        Union[Union[dict, "Relationship"], list[Union[dict, "Relationship"]]]
    ],
...
slots.Dataset_related_resource = Slot(
    ...
    curie=DCTERMS.curie("relation"),
    model_uri=DCATAP_PLUS.Dataset_related_resource,
    domain=Dataset,
    range=Optional[
        Union[
            dict[Union[str, ResourceId], Union[dict, "Resource"]],
...
slots.Dataset_release_date = Slot(
    ...
    curie=DCTERMS.curie("issued"),
    model_uri=DCATAP_PLUS.Dataset_release_date,
    domain=Dataset,
    range=Optional[Union[str, XSDDate]],
)
...
slots.Dataset_sample = Slot(
    ...
    name="Dataset_sample",
    curie=ADMS.curie("sample"),
    model_uri=DCATAP_PLUS.Dataset_sample,
    domain=Dataset,
    range=Optional[
        Union[Union[dict, "Distribution"], list[Union[dict, "Distribution"]]]
    ],
...
slots.Dataset_source = Slot(
    ...
    name="Dataset_source",
    curie=DCTERMS.curie("source"),
    model_uri=DCATAP_PLUS.Dataset_source,
    domain=Dataset,
    range=Optional[
        Union[
            dict[Union[str, DatasetId], Union[dict, "Dataset"]],
...
slots.Dataset_spatial_resolution = Slot(
    ...
    curie=DCAT.curie("spatialResolutionInMeters"),
    model_uri=DCATAP_PLUS.Dataset_spatial_resolution,
    domain=Dataset,
...
slots.Dataset_temporal_coverage = Slot(
    ...
    curie=DCTERMS.curie("temporal"),
    model_uri=DCATAP_PLUS.Dataset_temporal_coverage,
    domain=Dataset,
    range=Optional[
        Union[Union[dict, "PeriodOfTime"], list[Union[dict, "PeriodOfTime"]]]
    ],
...
slots.Dataset_temporal_resolution = Slot(
    ...
    curie=DCAT.curie("temporalResolution"),
    model_uri=DCATAP_PLUS.Dataset_temporal_resolution,
    domain=Dataset,
    range=Optional[str],
)
...
slots.Dataset_theme = Slot(
    ...
    name="Dataset_theme",
    curie=DCAT.curie("theme"),
    model_uri=DCATAP_PLUS.Dataset_theme,
    domain=Dataset,
    range=Optional[Union[Union[dict, "Concept"], list[Union[dict, "Concept"]]]],
)
...
slots.Dataset_title = Slot(
    ...
    name="Dataset_title",
    curie=DCTERMS.curie("title"),
    model_uri=DCATAP_PLUS.Dataset_title,
    domain=Dataset,
    range=Union[str, list[str]],
)
...
slots.Dataset_type = Slot(
    ...
    name="Dataset_type",
    curie=DCTERMS.curie("type"),
    model_uri=DCATAP_PLUS.Dataset_type,
    domain=Dataset,
    range=Optional[Union[Union[dict, "Concept"], list[Union[dict, "Concept"]]]],
)
...
slots.Dataset_version = Slot(
    ...
    curie=DCAT.curie("version"),
    model_uri=DCATAP_PLUS.Dataset_version,
    domain=Dataset,
    range=Optional[str],
)
...
slots.Dataset_version_notes = Slot(
    ...
    curie=ADMS.curie("versionNotes"),
    model_uri=DCATAP_PLUS.Dataset_version_notes,
    domain=Dataset,
    range=Optional[Union[str, list[str]]],
)
...
slots.Dataset_was_generated_by = Slot(
    ...
    curie=PROV.curie("wasGeneratedBy"),
    model_uri=DCATAP_PLUS.Dataset_was_generated_by,
    domain=Dataset,
    range=Union[
        dict[Union[str, DataGeneratingActivityId], Union[dict, DataGeneratingActivity]],
        list[Union[dict, DataGeneratingActivity]],
...
slots.DatasetSeries_applicable_legislation = Slot(
    ...
    curie=DCATAP.curie("applicableLegislation"),
    model_uri=DCATAP_PLUS.DatasetSeries_applicable_legislation,
...
slots.DatasetSeries_contact_point = Slot(
    ...
    curie=DCAT.curie("contactPoint"),
    model_uri=DCATAP_PLUS.DatasetSeries_contact_point,
    domain=DatasetSeries,
    range=Optional[Union[Union[dict, "Kind"], list[Union[dict, "Kind"]]]],
)
...
slots.DatasetSeries_description = Slot(
    ...
    curie=DCTERMS.curie("description"),
    model_uri=DCATAP_PLUS.DatasetSeries_description,
    domain=DatasetSeries,
    range=Union[str, list[str]],
)
...
slots.DatasetSeries_frequency = Slot(
    ...
    curie=DCTERMS.curie("accrualPeriodicity"),
    model_uri=DCATAP_PLUS.DatasetSeries_frequency,
    domain=DatasetSeries,
    range=Optional[Union[dict, "Frequency"]],
)
...
slots.DatasetSeries_geographical_coverage = Slot(
    ...
    curie=DCTERMS.curie("spatial"),
    model_uri=DCATAP_PLUS.DatasetSeries_geographical_coverage,
    domain=DatasetSeries,
    range=Optional[Union[Union[dict, "Location"], list[Union[dict, "Location"]]]],
)
...
slots.DatasetSeries_modification_date = Slot(
    ...
    curie=DCTERMS.curie("modified"),
    model_uri=DCATAP_PLUS.DatasetSeries_modification_date,
    domain=DatasetSeries,
    range=Optional[Union[str, XSDDate]],
)
...
slots.DatasetSeries_publisher = Slot(
    ...
    curie=DCTERMS.curie("publisher"),
    model_uri=DCATAP_PLUS.DatasetSeries_publisher,
    domain=DatasetSeries,
    range=Optional[Union[dict, Agent]],
)
...
slots.DatasetSeries_release_date = Slot(
    ...
    curie=DCTERMS.curie("issued"),
    model_uri=DCATAP_PLUS.DatasetSeries_release_date,
    domain=DatasetSeries,
    range=Optional[Union[str, XSDDate]],
)
...
slots.DatasetSeries_temporal_coverage = Slot(
    ...
    curie=DCTERMS.curie("temporal"),
    model_uri=DCATAP_PLUS.DatasetSeries_temporal_coverage,
    domain=DatasetSeries,
    range=Optional[
        Union[Union[dict, "PeriodOfTime"], list[Union[dict, "PeriodOfTime"]]]
    ],
...
slots.DatasetSeries_title = Slot(
    ...
    curie=DCTERMS.curie("title"),
    model_uri=DCATAP_PLUS.DatasetSeries_title,
    domain=DatasetSeries,
    range=Union[str, list[str]],
)
...
slots.DefinedTerm_title = Slot(
    ...
    model_uri=DCATAP_PLUS.DefinedTerm_title,
    domain=DefinedTerm,
    range=Optional[str],
)
...
slots.Device_has_part = Slot(
    ...
    curie=DCTERMS.curie("hasPart"),
    model_uri=DCATAP_PLUS.Device_has_part,
    domain=Device,
    range=Optional[
        Union[
            dict[Union[str, DeviceId], Union[dict, "Device"]],
...
slots.Device_other_identifier = Slot(
    ...
    curie=ADMS.curie("identifier"),
    model_uri=DCATAP_PLUS.Device_other_identifier,
    domain=Device,
    range=Optional[Union[Union[dict, "Identifier"], list[Union[dict, "Identifier"]]]],
)
...
slots.Distribution_access_URL = Slot(
    ...
    curie=DCAT.curie("accessURL"),
    model_uri=DCATAP_PLUS.Distribution_access_URL,
    domain=Distribution,
    range=Union[
        dict[Union[str, ResourceId], Union[dict, "Resource"]],
        list[Union[dict, "Resource"]],
...
slots.Distribution_access_service = Slot(
    ...
    curie=DCAT.curie("accessService"),
    model_uri=DCATAP_PLUS.Distribution_access_service,
    domain=Distribution,
    range=Optional[Union[Union[dict, DataService], list[Union[dict, DataService]]]],
)
...
slots.Distribution_applicable_legislation = Slot(
    ...
    curie=DCATAP.curie("applicableLegislation"),
    model_uri=DCATAP_PLUS.Distribution_applicable_legislation,
    domain=Distribution,
    range=Optional[
        Union[
            dict[Union[str, LegalResourceId], Union[dict, "LegalResource"]],
...
slots.Distribution_availability = Slot(
    ...
    curie=DCATAP.curie("availability"),
    model_uri=DCATAP_PLUS.Distribution_availability,
    domain=Distribution,
    range=Optional[Union[dict, "Concept"]],
)
...
slots.Distribution_byte_size = Slot(
    ...
    curie=DCAT.curie("byteSize"),
    model_uri=DCATAP_PLUS.Distribution_byte_size,
    domain=Distribution,
    range=Optional[int],
)
...
slots.Distribution_checksum = Slot(
    ...
    curie=SPDX.curie("checksum"),
    model_uri=DCATAP_PLUS.Distribution_checksum,
    domain=Distribution,
...
slots.Distribution_compression_format = Slot(
    ...
    curie=DCAT.curie("compressFormat"),
    model_uri=DCATAP_PLUS.Distribution_compression_format,
    domain=Distribution,
...
slots.Distribution_description = Slot(
    ...
    curie=DCTERMS.curie("description"),
    model_uri=DCATAP_PLUS.Distribution_description,
    domain=Distribution,
    range=Optional[Union[str, list[str]]],
)
...
slots.Distribution_documentation = Slot(
    ...
    curie=FOAF.curie("page"),
    model_uri=DCATAP_PLUS.Distribution_documentation,
    domain=Distribution,
    range=Optional[
        Union[
            dict[Union[str, DocumentId], Union[dict, "Document"]],
...
slots.Distribution_download_URL = Slot(
    ...
    curie=DCAT.curie("downloadURL"),
    model_uri=DCATAP_PLUS.Distribution_download_URL,
    domain=Distribution,
    range=Optional[
        Union[
            dict[Union[str, ResourceId], Union[dict, "Resource"]],
...
slots.Distribution_format = Slot(
    ...
    curie=DCTERMS.curie("format"),
    model_uri=DCATAP_PLUS.Distribution_format,
    domain=Distribution,
...
slots.Distribution_has_policy = Slot(
    ...
    curie=ODRL.curie("hasPolicy"),
    model_uri=DCATAP_PLUS.Distribution_has_policy,
    domain=Distribution,
...
slots.Distribution_language = Slot(
    ...
    curie=DCTERMS.curie("language"),
    model_uri=DCATAP_PLUS.Distribution_language,
    domain=Distribution,
    range=Optional[
        Union[Union[dict, "LinguisticSystem"], list[Union[dict, "LinguisticSystem"]]]
    ],
...
slots.Distribution_licence = Slot(
    ...
    curie=DCTERMS.curie("license"),
    model_uri=DCATAP_PLUS.Distribution_licence,
    domain=Distribution,
    range=Optional[Union[dict, "LicenseDocument"]],
)
...
slots.Distribution_linked_schemas = Slot(
    ...
    curie=DCTERMS.curie("conformsTo"),
    model_uri=DCATAP_PLUS.Distribution_linked_schemas,
    domain=Distribution,
    range=Optional[Union[Union[dict, "Standard"], list[Union[dict, "Standard"]]]],
)
...
slots.Distribution_media_type = Slot(
    ...
    curie=DCAT.curie("mediaType"),
    model_uri=DCATAP_PLUS.Distribution_media_type,
    domain=Distribution,
    range=Optional[Union[dict, "MediaType"]],
)
...
slots.Distribution_modification_date = Slot(
    ...
    curie=DCTERMS.curie("modified"),
    model_uri=DCATAP_PLUS.Distribution_modification_date,
    domain=Distribution,
    range=Optional[Union[str, XSDDate]],
)
...
slots.Distribution_packaging_format = Slot(
    ...
    curie=DCAT.curie("packageFormat"),
    model_uri=DCATAP_PLUS.Distribution_packaging_format,
    domain=Distribution,
    range=Optional[Union[dict, "MediaType"]],
)
...
slots.Distribution_release_date = Slot(
    ...
    curie=DCTERMS.curie("issued"),
    model_uri=DCATAP_PLUS.Distribution_release_date,
    domain=Distribution,
    range=Optional[Union[str, XSDDate]],
)
...
slots.Distribution_rights = Slot(
    ...
    curie=DCTERMS.curie("rights"),
    model_uri=DCATAP_PLUS.Distribution_rights,
    domain=Distribution,
    range=Optional[Union[dict, "RightsStatement"]],
)
...
slots.Distribution_spatial_resolution = Slot(
    ...
    curie=DCAT.curie("spatialResolutionInMeters"),
    model_uri=DCATAP_PLUS.Distribution_spatial_resolution,
    domain=Distribution,
    range=Optional[Decimal],
)
...
slots.Distribution_status = Slot(
    ...
    curie=ADMS.curie("status"),
    model_uri=DCATAP_PLUS.Distribution_status,
    domain=Distribution,
    range=Optional[Union[dict, "Concept"]],
)
...
slots.Distribution_temporal_resolution = Slot(
    ...
    curie=DCAT.curie("temporalResolution"),
    model_uri=DCATAP_PLUS.Distribution_temporal_resolution,
    domain=Distribution,
    range=Optional[str],
)
...
slots.Distribution_title = Slot(
    ...
    curie=DCTERMS.curie("title"),
    model_uri=DCATAP_PLUS.Distribution_title,
    domain=Distribution,
    range=Optional[Union[str, list[str]]],
)
...
slots.Entity_title = Slot(
    ...
    name="Entity_title",
    curie=DCTERMS.curie("title"),
    model_uri=DCATAP_PLUS.Entity_title,
    domain=Entity,
    range=Optional[str],
)
...
slots.Entity_description = Slot(
    ...
    curie=DCTERMS.curie("description"),
    model_uri=DCATAP_PLUS.Entity_description,
    domain=Entity,
    range=Optional[str],
)
...
slots.Entity_other_identifier = Slot(
    ...
    curie=ADMS.curie("identifier"),
    model_uri=DCATAP_PLUS.Entity_other_identifier,
    domain=Entity,
    range=Optional[Union[Union[dict, "Identifier"], list[Union[dict, "Identifier"]]]],
)
...
slots.Entity_has_part = Slot(
    ...
    curie=DCTERMS.curie("hasPart"),
    model_uri=DCATAP_PLUS.Entity_has_part,
    domain=Entity,
    range=Optional[
        Union[
            dict[Union[str, EntityId], Union[dict, "Entity"]],
...
slots.Entity_part_of = Slot(
    ...
    name="Entity_part_of",
    curie=DCTERMS.curie("isPartOf"),
    model_uri=DCATAP_PLUS.Entity_part_of,
    domain=Entity,
    range=Optional[
        Union[
            dict[Union[str, EntityId], Union[dict, "Entity"]],
...
slots.EvaluatedActivity_other_identifier = Slot(
    ...
    curie=ADMS.curie("identifier"),
    model_uri=DCATAP_PLUS.EvaluatedActivity_other_identifier,
...
slots.EvaluatedEntity_title = Slot(
    ...
    curie=DCTERMS.curie("title"),
    model_uri=DCATAP_PLUS.EvaluatedEntity_title,
...
slots.EvaluatedEntity_description = Slot(
    ...
    curie=DCTERMS.curie("description"),
    model_uri=DCATAP_PLUS.EvaluatedEntity_description,
    domain=EvaluatedEntity,
    range=Optional[str],
)
...
slots.EvaluatedEntity_was_generated_by = Slot(
    ...
    curie=PROV.curie("wasGeneratedBy"),
    model_uri=DCATAP_PLUS.EvaluatedEntity_was_generated_by,
    domain=EvaluatedEntity,
    range=Optional[
        Union[
            dict[Union[str, ActivityId], Union[dict, Activity]],
...
slots.EvaluatedEntity_other_identifier = Slot(
    ...
    curie=ADMS.curie("identifier"),
    model_uri=DCATAP_PLUS.EvaluatedEntity_other_identifier,
    domain=EvaluatedEntity,
    range=Optional[Union[Union[dict, "Identifier"], list[Union[dict, "Identifier"]]]],
)
...
slots.Identifier_notation = Slot(
    ...
    curie=SKOS.curie("notation"),
    model_uri=DCATAP_PLUS.Identifier_notation,
    domain=Identifier,
    range=str,
)
...
slots.LicenseDocument_type = Slot(
    ...
    curie=DCTERMS.curie("type"),
    model_uri=DCATAP_PLUS.LicenseDocument_type,
...
slots.Location_bbox = Slot(
    ...
    name="Location_bbox",
    curie=DCAT.curie("bbox"),
    model_uri=DCATAP_PLUS.Location_bbox,
    domain=Location,
    range=Optional[str],
)
...
slots.Location_centroid = Slot(
    ...
    curie=DCAT.curie("centroid"),
    model_uri=DCATAP_PLUS.Location_centroid,
    domain=Location,
    range=Optional[str],
)
...
slots.Location_geometry = Slot(
    ...
    curie=LOCN.curie("geometry"),
    model_uri=DCATAP_PLUS.Location_geometry,
    domain=Location,
...
slots.PeriodOfTime_beginning = Slot(
    ...
    curie=TIME.curie("hasBeginning"),
    model_uri=DCATAP_PLUS.PeriodOfTime_beginning,
    domain=PeriodOfTime,
...
slots.PeriodOfTime_end = Slot(
    ...
    curie=TIME.curie("hasEnd"),
    model_uri=DCATAP_PLUS.PeriodOfTime_end,
    domain=PeriodOfTime,
    range=Optional[Union[dict, "TimeInstant"]],
)
...
slots.PeriodOfTime_end_date = Slot(
    ...
    curie=DCAT.curie("endDate"),
    model_uri=DCATAP_PLUS.PeriodOfTime_end_date,
    domain=PeriodOfTime,
    range=Optional[Union[str, XSDDate]],
)
...
slots.PeriodOfTime_start_date = Slot(
    ...
    curie=DCAT.curie("startDate"),
    model_uri=DCATAP_PLUS.PeriodOfTime_start_date,
    domain=PeriodOfTime,
    range=Optional[Union[str, XSDDate]],
)
...
slots.QualitativeAttribute_value = Slot(
    ...
    curie=PROV.curie("value"),
    model_uri=DCATAP_PLUS.QualitativeAttribute_value,
...
slots.QuantitativeAttribute_value = Slot(
    ...
    curie=PROV.curie("value"),
    model_uri=DCATAP_PLUS.QuantitativeAttribute_value,
...
slots.Relationship_had_role = Slot(
    ...
    curie=DCAT.curie("hadRole"),
    model_uri=DCATAP_PLUS.Relationship_had_role,
    domain=Relationship,
...
slots.Relationship_relation = Slot(
    ...
    curie=DCTERMS.curie("relation"),
    model_uri=DCATAP_PLUS.Relationship_relation,
    domain=Relationship,
    range=Union[
        dict[Union[str, ResourceId], Union[dict, "Resource"]],
        list[Union[dict, "Resource"]],
...
slots.Software_has_part = Slot(
    ...
    curie=DCTERMS.curie("hasPart"),
    model_uri=DCATAP_PLUS.Software_has_part,
    domain=Software,
    range=Optional[
        Union[
            dict[Union[str, SoftwareId], Union[dict, "Software"]],
...
slots.Software_other_identifier = Slot(
    ...
    curie=ADMS.curie("identifier"),
    model_uri=DCATAP_PLUS.Software_other_identifier,
    domain=Software,
    range=Optional[Union[Union[dict, "Identifier"], list[Union[dict, "Identifier"]]]],
)
