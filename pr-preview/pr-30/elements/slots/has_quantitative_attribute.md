...
_The slot to relate a quantitative attribute to an EvaluatedEntity, EvaluatedActivity or AgenticEntity_
...
* Range: [QuantitativeAttribute](../classes/QuantitativeAttribute.md)
...
| native | dcatap_plus:has_quantitative_attribute |
...
description: The slot to relate a quantitative attribute to an EvaluatedEntity, EvaluatedActivity
  or AgenticEntity
in_subset:
